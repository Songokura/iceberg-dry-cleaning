...
(function () {
  ...
  var KK = {
    ...
    p_d5: "5 орындық",
    p_d6: "6 орындық",
    p_draz: "Жайылмалы, ұйықтайтын орнымен",
    v_draz: "10 000 – 30 000 ₸",
    ...
    q8: "Жайылмалы диван басқаша есептеле ме?",
    a8: "Иә. Диванды жайып, ұйықтайтын орнымен бірге тазаласақ, жұмыс көбірек — 2 орындық үшін 10 000 ₸-ден 6 орындық үшін 30 000 ₸-ге дейін. Нақты соманы WhatsApp арқылы фото бойынша айтамыз.",
