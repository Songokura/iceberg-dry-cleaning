...
(function () {
  ...
  var MQ = "<span>Диван ❄ Кресло ❄ Матрас ❄ Кілем ❄ Сәби арбасы ❄ Автокресло ❄ Төсек ❄ Орындық ❄ Ковролин ❄ Бумен дезинфекциялау ❄ </span>";

  var KK = {
    /* шапка */
    nav_serv: "Қызметтер", nav_ba: "Дейін / кейін", nav_proc: "Процесс",
    nav_price: "Бағалар", nav_faq: "Сұрақтар", nav_cont: "Байланыс",
    call: "Қоңырау шалу", burger_al: "Мәзірді ашу", nav_al: "Негізгі навигация",
    lang_al: "Сайт тілі",

    /* первый экран */
    hero_kick: '<span class="pulse-dot" aria-hidden="true"></span>Астана · үйге барып тазалаймыз',
    hero_h1: '<span class="hero__line"><i>Терең</i> химиялық тазалау</span>' +
             '<span class="hero__line">жұмсақ жиһазға —</span>' +
             '<span class="hero__line hero__line--accent">үйіңізде</span>',
    hero_sub: "Диван, матрас, кілем және сәби арбасы. Америкалық эко-химия, Германия мен Италия " +
    ...
    /* эффект айсберга */
    berg_al: "Айсберг әсері: кірдің 90% көрінбейді",
    berg_label: "Айсберг әсері",
    berg_h2: "Көзге көрінетін тазалық —<br>тек шыңы ғана",
    berg_text: "кір қаптаманың <b>астында</b> тұрады: шаң, аллергендер мен иіс толтырғыштың " +
    ...
    serv_note: "Люкс маталарды қоса, матаның барлық түрімен жұмыс істейміз. " +
               "Карточканы бассаңыз — дайын сұрауы бар WhatsApp ашылады.",
    c_divany_t: "Дивандар",     c_divany_p: "<b>14 000 ₸</b>-ден бастап · отыратын орын — 3 500 ₸",
    c_kresla_t: "Креслолар",    c_kresla_p: "<b>3 500 ₸</b>",
    c_stulya_t: "Орындықтар",   c_stulya_p: "фото бойынша есептеу",
    c_matrasy_t: "Матрастар",   c_matrasy_p: "фото бойынша WhatsApp арқылы есептеу",
    c_krovati_t: "Төсектер",    c_krovati_p: "қаптама мен бас жағы · фото бойынша есептеу",
    ...
    c_dezinfekciya_p: "20 000 ₸-ден жоғары тапсырысқа <b>сыйлыққа</b>",
    ...
    st1_p: "Қаптама мен кірдің түрін анықтаймыз — соған қарай құрам таңдаймыз. Люкс маталарды қоса, барлық матамен жұмыс істейміз.",
    st2_t: "Құрғақ тазалау",
    st2_p: "Кәсіби шаңсорғыш бетіндегі және қатпарлардағы шаң мен құрғақ қоқысты жинайды.",
    st3_t: "АҚШ эко-химиясы",
    st3_p: "Америкалық эко-құрамды жағамыз — ол кірді тек бетінде емес, талшық тереңінде ыдыратады.",
    st4_t: "Экстракция",
    ...
    pr1_n: "Отыратын орын",       pr1_v: "3 500 ₸",
    pr2_n: "Кресло",              pr2_v: "3 500 ₸",
    pr3_n: "3 орындық диван",     pr3_v: "14 000 ₸-ден бастап",
    pr4_n: "Сәби арбасы",         pr4_v: "12 000 – 20 000 ₸",
    pr5_n: "Кілемдер",            pr5_v: "1 000 ₸/м²-ден бастап",
    pr6_n: "Ковролин",            pr6_v: "1 000 ₸/м²",
    pr7_n: "Матрас · автокресло · төсек", pr7_v: "фото бойынша есептеу",
    pr8_n: "Ең төмен тапсырыс",   pr8_v: "10 000 ₸",

    /* акция */
    promo_label: "Сыйлық",
    promo_h2: "20 000 ₸-ден жоғары тапсырысқа —<br>жиһазды <em>бумен дезинфекциялау</em> сыйлыққа",
    ...
    v2_badge: "процесс",    v2_t: "Экстракция тікелей", v2_s: "Instagram парақшасынан көру · «До и после» бөлімі",
    ...
    a1: "Негізгі бағалар — жоғарыдағы прайста: отыратын орын 3 500 ₸, 3 орындық диван 14 000 ₸-ден. " +
    ...
    a4: "Иә, люкс маталарды қоса, барлық түрін тазалаймыз. Шебер Алматыдағы клининг мектебінде және " +
    ...
    a5: "Тапсырыс сомасын 20 000 ₸-ден жоғары жинасаңыз болды — жиһазды бумен дезинфекциялауды тегін жасаймыз.",
    ...
    ct_l3: "Instagram", ct_l4: "Мекенжай",
    ...
    f_note: "Түйме дайын хабарламасы бар WhatsApp ашады — қайта теруге тура келмейді.",
    f_thx_b: "Рақмет! ❄",
    f_thx_p: "Хабарлама дайындалды — оны WhatsApp ішінде қарап шығып, «Жіберу» түймесін басыңыз. Тез жауап береміз.",

    /* футер */
    foot_addr: "Астана, Манатау көшесі, 17<br>Жұмсақ жиһазды үйге барып тазалау"
  };
  ...
  var META = {
    ...
    kk: {
      ...
      d: "Астанада диван, матрас, кілем және сәби арбасын үйге барып химиялық тазалау. Америкалық эко-химия, " +
         "Германия мен Италия жабдығы, 5 жыл тәжірибе. Отыратын орын — 3 500 ₸. WhatsApp арқылы фото бойынша есептеу."
    }
  };
